...
(fset 'refactor-google-translate-question
      (kmacro-lambda-form [?v ?i ?p ?J escape ?v ?i ?p ?: ?s ?/ ?+ ?/ ?\\ ?n ?+ ?/ ?g return ?v ?i ?p ?: ?s ?/ ?- ?/ ?\\ ?n ?- ?/ ?g return ?v ?i ?p ?: ?s ?/ ?\\ ?  ?\\ ?n ?/ ?\\ ?n ?/ ?g return] 0 "%d")
)

(fset 'text-to-gift-question
   (kmacro-lambda-form [?l ?I ?: ?: escape ?l ?v ?w ?w ?e ?y ?h ?a ?a backspace escape ?p ?a ?: ?: ?\[ ?h ?t ?m ?l ?\] ?< ?p ?> escape ?A ?  ?< ?b ?r ?  ?/ ?> ?< ?b ?r ?  ?/ ?> ?< ?p ?> ?\{ escape ?\} ?O ?\} escape ?\C-o ?j ?V ?\} ?k ?k ?: ?s ?/ ?^ ?- ?/ ?  ?  ?  ?  ?< ?p ?> return ?V ?\{ ?j ?j ?: ?s ?/ ?$ ?/ ?< ?/ ?p ?> ?/ left left left left left right ?\\ right right right return ?V ?\{ ?j ?j ?: ?s ?/ ?< ?p ?> ?/ ?~ ?< ?p ?> ?. backspace ?/ left left left left left ?\\ backspace ?\\ right right right right right return] 0 "%d"))
